...
module.exports = class rewardsPayoutProcess1670595306602 {
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "wallet" ADD "addressId" int NOT NULL`);
        await queryRunner.query(`ALTER TABLE "staking" ADD "rewardsPayoutAddressId" int NOT NULL`);
        await queryRunner.query(`ALTER TABLE "staking" ADD "withdrawalAddressId" int NOT NULL`);
        await queryRunner.query(`ALTER TABLE "staking" ADD "depositAddressId" int NOT NULL`);
        await queryRunner.query(`ALTER TABLE "pay_in" ADD "addressId" int NOT NULL`);
